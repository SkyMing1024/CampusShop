            ...
            <div class="main center">
                ...
                <div class="upload-wr">
                    <div class="clone-target">
                        <div class="photo">
                            <div>
                                <img src="imgs/release" alt="" class="image"></div>
                    ...
                    <div class="photo-area init-up">
                        <div class="upload-area" id="upload-area" style="position: relative;">
                            ...
                            <div id="html5_1bf7kjaid1u048gce9t1r9sk3m3_container" class="moxie-shim moxie-shim-html5" style="position: absolute; top: 2px; left: 0px; width: 160px; height: 160px; overflow: hidden; z-index: 49;">
                                <input id="html5_1bf7kjaid1u048gce9t1r9sk3m3" style="font-size: 999px; opacity: 0; position: absolute; top: 0px; left: 0px; width: 100%; height: 100%;" accept="image/*" capture="camera" type="file"></div>
                        </div>
